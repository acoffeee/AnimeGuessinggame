...
def oknowtheactualguesspartihavennocludewtfimdoingimissai(animepool):
    Bwomp = len(animepool)
    print(animepool[0])
animepool = game_difficulty()
oknowtheactualguesspartihavennocludewtfimdoingimissai(animepool)
